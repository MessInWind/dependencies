...
/* ./.libs/lt-pngunknown.c - temporary wrapper executable for .libs/pngunknown.exe
...
const char * LIB_PATH_VALUE   = "/mnt/e/repo/dependencies/libpng-1.6.37/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/usr/i686-w64-mingw32/lib;/usr/i686-w64-mingw32/bin;/mnt/e/repo/dependencies/libpng-1.6.37/.libs;";
const char * TARGET_PROGRAM_NAME = "pngunknown.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# pngunknown - temporary wrapper script for .libs/pngunknown.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The pngunknown program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libpng16.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"pngunknown.exe:pngunknown:$LINENO: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"pngunknown.exe:pngunknown:$LINENO: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"pngunknown.exe:pngunknown:$LINENO: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
  ...
  fputs ("    PATH=/usr/i686-w64-mingw32/lib:/usr/i686-w64-mingw32/bin:/mnt/e/repo/depend", f);
  fputs ("encies/libpng-1.6.37/.libs:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/mnt/e/repo/dependencies/libpng-1.6.37/.libs:$PATH\"\n", f);
  fputs ("\n", f);
