...
/* ./.libs/lt-png-fix-itxt.c - temporary wrapper executable for .libs/png-fix-itxt.exe
   Generated by libtool (GNU libtool) 2.4.6

   The png-fix-itxt program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "/usr/i686-w64-mingw32/lib;/usr/i686-w64-mingw32/bin;";
const char * TARGET_PROGRAM_NAME = "png-fix-itxt.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# png-fix-itxt - temporary wrapper script for .libs/png-fix-itxt.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The png-fix-itxt program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"png-fix-itxt.exe:png-fix-itxt:$LINENO: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"png-fix-itxt.exe:png-fix-itxt:$LINENO: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"png-fix-itxt.exe:png-fix-itxt:$LINENO: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='png-fix-itxt.exe'\n", f);
  ...
  fputs ("    PATH=/usr/i686-w64-mingw32/lib:/usr/i686-w64-mingw32/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
